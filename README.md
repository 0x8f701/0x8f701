...
- 3️⃣ parallel computing with software (Spark) and hardware (CUDA/FPGA)
...
Now I'm leading the [**Protocol Development**](https://app.para.space) at [@ParaSpace](https://twitter.com/ParaSpace_NFT).
